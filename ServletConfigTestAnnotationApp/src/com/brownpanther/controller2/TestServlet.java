package com.brownpanther.controller2;
...
@WebServlet(
		urlPatterns = { "/test" }, 
		initParams = { 
				@WebInitParam(name = "State", value = "KentuckyTestFromAnn")
		})
public class TestServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
   static {
	   System.out.println("In TestServlet static block");
	   
   }
	
    public TestServlet() {
    	System.out.println("In TestServlet Constructor");
        
    }
    @Override
    public void init() {
    	System.out.println("In TestServlet life cycle method init");
    }
	...
	@Override
	public void destroy() {
		System.out.println("In TestServlet life cycle method destroy");
